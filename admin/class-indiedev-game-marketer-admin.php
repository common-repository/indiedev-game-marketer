...
class Indiedev_Game_Marketer_Admin {
	 ...
	 */
		public function idgm_admin_menu() {
			 ...
			 add_menu_page( __('IndieDev Game Marketer', $this->plugin_name), __('IndieDev Game Marketer', $this->plugin_name), 'manage_options', $this->plugin_name, array($this, 'display_plugin_admin_page'), 'dashicons-idgm', 66);
       ...
       public function Indiedev_Game_Marketer_select_twitter_secret(  ) { 
		...
		public function Indiedev_Game_Marketer_diagnostics_page() {
     echo '<div class="grid_16">';
        echo '
				<div class="ui-widget">
					<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
						<p>
						<strong>'.__('WARNING','indiedev-game-marketer').':</strong> '.__('Do not post this code in a public place.  The code below contains sensitive information about your site.  Only share this information with parties you trust, such as this plugins developer, your web developers, etc.  The information here may be useful for technicians to diagnose what may be causing an issue that you have.  To view this data, run it through the base64_decode() PHP function ', 'indiedev-game-marketer');
						
						echo '</p>
					</div>
				</div><br />   ';        
            
            _e('Please email the diagnostic data in the box below to jeff@blacklodgegames.com when seeking support:','indiedev-game-marketer');
            ...
            $output = '<pre>';
            $output .= "===== Indiedev_Game_Marketer settings =====
            ";
...
';
        ...
        <table class="form-table"><tbody>
            ...
            <tr>
                <th scope="row"><?php _e( "Community Managers", 'indiedev-game-marketer' ); ?></th>
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-new-game-form-community-managers' id='idgm-new-game-form-community-managers' value=''>
                <br /><?php _e( "A list of the game's notable community managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr> 
            <tr>
                <th scope="row"><?php _e( "PR Managers", 'indiedev-game-marketer' ); ?></th>
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-new-game-form-pr-managers' id='idgm-new-game-form-pr-managers' value=''>
                <br /><?php _e( "A list of the game's notable PR managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr> 
            <tr>
                <th scope="row"><?php _e( "Social Media Managers", 'indiedev-game-marketer' ); ?></th>
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-new-game-form-social-media-manager' id='idgm-new-game-form-social-media-manager' value=''>
                <br /><?php _e( "A list of the game's notable social media managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr>                                     
            <tr>
        ...
        <table class="form-table"><tbody>
            ...
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-edit-game-form-community-managers' id='idgm-edit-game-form-community-managers' value=''>
                <br /><?php _e( "A list of the game's notable community managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr> 
            <tr>
            ...
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-edit-game-form-pr-managers' id='idgm-edit-game-form-pr-managers' value=''>
                <br /><?php _e( "A list of the game's notable PR managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr> 
            <tr>
            ...
            <td>  
                <div class="idgm-box">
                <input type='text' name='idgm-edit-game-form-social-media-manager' id='idgm-edit-game-form-social-media-manager' value=''>
                <br /><?php _e( "A list of the game's notable social media managers, separated by commas.", 'indiedev-game-marketer' ); ?>
                </div> 
            </td></tr>              
        ...
        public function idgm_test_twitter() {
            echo __(sprintf('PHP must be 7.1 or higher.  Your version of PHP is %s.' , phpversion() ), 'indiedev-game-marketer'). '<br />';
            ...
            <script type="text/javascript" >
                ...
                jQuery(document).on( 'click', '#idgm-new-game-form-save-button', function() {
                        ...
                        var data = {
                                ...
                                'community_managers': jQuery('#idgm-new-game-form-community-managers').val(),
                                'pr_managers': jQuery('#idgm-new-game-form-pr-managers').val(),
                                'social_media_manager': jQuery('#idgm-new-game-form-social-media-manager').val(),
                        ...
                        jQuery.post(ajaxurl, data, function(response) {
                                ...
                                jQuery('#idgm-new-game-form-community-managers').val('');
                                jQuery('#idgm-new-game-form-pr-managers').val('');
                                jQuery('#idgm-new-game-form-social-media-manager').val('');
        ...
        public function idgm_ajax_save_game_callback() {
			...
			$db_input['community_managers'] = sanitize_text_field($_POST['community_managers']);
			$db_input['pr_managers'] = sanitize_text_field($_POST['pr_managers']);
			$db_input['social_media_manager'] = sanitize_text_field($_POST['social_media_manager']);
            ...
            <script type="text/javascript" >                   
                ...
                jQuery(document).on( 'click', '#idgm-edit-game-form-save-button', function() {
                        ...
                        var data = {
                                ...
                                'community_managers': jQuery('#idgm-edit-game-form-community-managers').val(),
                                'pr_managers': jQuery('#idgm-edit-game-form-pr-managers').val(),
                                'social_media_manager': jQuery('#idgm-edit-game-form-social-media-manager').val(),
	...
	public function add_settings_link( $links ) {
		...
		$mylinks = array(
			'<a href="' . admin_url( 'admin.php?page=indiedev-game-marketer' ) . '"><strong>'.__('Settings','indiedev-game-marketer').'</strong></a>',
		);
		return array_merge( $links, $mylinks );
	}        
        
	/**
	 * Adds a new category to the blocks interface
	 *
	 * @since 		2.0.0
	 * @return 		mixed
	 */		
	function add_block_category( $categories, $post=null ) {
		return array_merge(
			...
			array(
				array(
					'slug' => 'indiedev-game-marketer-blocks',
					'title' => __( 'IndieDev Game Marketer', 'indiedev-game-marketer' ),
				),
			)
		);
	}	
	...
	/**
	 * Adds a custom dashicon to the blocks interface
	 *
	 * @since 		2.0.0
	 */	
	function custom_dashicon_idgm() {
	  echo '
	    <style>
	    .dashicons-idgm {
	        background-image: url("'.plugins_url().'/indiedev-game-marketer/images/icon.png");
