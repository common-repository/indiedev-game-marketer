        ...
        jQuery(document).ready(function() {
            jQuery('#idgm-tweet-box').on('input', function() {
                ...
                jQuery("#idgm-twitter-characters").html( "<span style='color:"+style_value_for_count+"'>" + (280 - this.value.length) + "</span>" );
...
function idgmEditGame(game_array) {
    ...
    jQuery('#idgm-edit-game-form-community-managers').val(gameData.community_managers);
    jQuery('#idgm-edit-game-form-pr-managers').val(gameData.pr_managers);
    jQuery('#idgm-edit-game-form-social-media-manager').val(gameData.social_media_manager);
