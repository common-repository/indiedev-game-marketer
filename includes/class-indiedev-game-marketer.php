...
class Indiedev_Game_Marketer {
	...
	public function __construct() {
        ...
        $Indiedev_Game_Marketer_dbVersion = '2.0.7';
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_filter( 'block_categories', $plugin_admin, 'add_block_category' ); 
		$this->loader->add_action( 'admin_head', $plugin_admin, 'custom_dashicon_idgm' );  
	}
