	...
	public static function activate($networkwide) {
        ...
        public static function createDb() {
            ...
            $sql = "CREATE TABLE {$table_name} (
              ...
              community_managers varchar(254) DEFAULT '' NOT NULL, 
              pr_managers varchar(254) DEFAULT '' NOT NULL, 
              social_media_manager varchar(254) DEFAULT '' NOT NULL,                
              ...
              release_date_a date DEFAULT '2019-01-01' NOT NULL,
              platform_b varchar(254) DEFAULT '' NOT NULL,
              release_date_b date DEFAULT '2019-01-01' NOT NULL,              
              platform_c varchar(254) DEFAULT '' NOT NULL,
              release_date_c date DEFAULT '2019-01-01' NOT NULL,              
              platform_d varchar(254) DEFAULT '' NOT NULL,
              release_date_d date DEFAULT '2019-01-01' NOT NULL,              
              platform_e varchar(254) DEFAULT '' NOT NULL,
              release_date_e date DEFAULT '2019-01-01' NOT NULL,              
              platform_f varchar(254) DEFAULT '' NOT NULL,
              release_date_f date DEFAULT '2019-01-01' NOT NULL,              
              platform_g varchar(254) DEFAULT '' NOT NULL,
              release_date_g date DEFAULT '2019-01-01' NOT NULL,              
              platform_h varchar(254) DEFAULT '' NOT NULL,
              release_date_h date DEFAULT '2019-01-01' NOT NULL,              
              platform_i varchar(254) DEFAULT '' NOT NULL,
              release_date_i date DEFAULT '2019-01-01' NOT NULL,              
              platform_j varchar(254) DEFAULT '' NOT NULL,
              release_date_j date DEFAULT '2019-01-01' NOT NULL,   
        ...
        public static function upgradeDb() {
            ...
            $row = $wpdb->get_results(  "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE table_name = '{$wpdb->prefix}idgm_games' AND column_name = 'community_managers'"  );

            if(empty($row)){
               $wpdb->query("ALTER TABLE `{$wpdb->prefix}idgm_games` ADD `community_managers` varchar(254) NOT NULL AFTER `composers`;");
               $wpdb->query("ALTER TABLE `{$wpdb->prefix}idgm_games` ADD `pr_managers` varchar(254) NOT NULL AFTER `community_managers`;");
			   $wpdb->query("ALTER TABLE `{$wpdb->prefix}idgm_games` ADD `social_media_manager` varchar(254) NOT NULL AFTER `cpr_managers`;");
            } 			            
